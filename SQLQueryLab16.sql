...
CC varchar(300)
    ...
    create  trigger TR_TEACHER_INS 
	  ...
	  insert into  TEACHER values('Ивdcswihj', 'Иванов', 'м', 'ИСиТ');
   ...
   print 'Событие: INSERT';
	...
	print 'Событие: UPDATE'; 
	  ...
	  insert into  TEACHER values('Ив', 'Иванов', 'м', 'ИСиТ');
	  	  update TEACHER set GENDER = 'ж' where TEACHER like 'Ив'
	  select * from TR_AUDIT
...
update TEACHER set GENDER = 'афыфвыпвыпы' where TEACHER like 'Бракович'
 select * from TR_AUDIT

--6

--Создать для таблицы FACULTY три AFTER-триггера с именами: TR_FACULTY_ DEL1, TR_FACULTY_DEL2 и TR_FACULTY_ DEL3. 
--Триггеры должны реагировать на собы-тие DELETE и формировать соответствующие строки в таблицу TR_AUDIT. 
-- Получить полный список триггеров, связан-ных с таблицей FACULTY. Упорядочить вы-полнение триггеров для 
--таблицы FACULTY, реагирующих на событие DELETE следующим образом: первым должен выполняться триггер с 
--именем TR_FACULTY_DEL3, последним – триггер TR_FACULTY_DEL2. 
...
delete from FACULTY where FACULTY like 'Кирдун';
go
use RAM_UNIVER
	go   
...
go 
	...
	insert into PULPIT(PULPIT) values ('КСИС')
