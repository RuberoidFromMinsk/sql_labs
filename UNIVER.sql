...
create database RAM_UNIVER
on primary
( name = FACULTY, filename =  N'C:\UNIVER\ RAM_FACULTY.mdf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb),
( name = AUDITORIUM_TYPE, filename = N'C:\UNIVER\ RAM_AUDITORIUM_TYPE.ndf', 
   size = 5Mb, maxsize=10Mb ,filegrowth=10%),
( name = PROFESSION, filename = N'C:\UNIVER\ RAM_PROFESSION.ndf', 
   size = 5Mb, maxsize=10Mb ,filegrowth=10%),
filegroup G1
( name = PULPIT, filename = N'C:\UNIVER\ RAM_PULPIT.ndf', 
   size = 10Mb, maxsize=15Mb, filegrowth=1Mb),
( name = SUBJECT, filename = N'C:\UNIVER\ RAM_SUBJECT.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
( name = GROUPS, filename = N'C:\UNIVER\ RAM_GROUPS.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
(name = TEACHER, filename = N'C:\UNIVER\ RAM_TEACHER.ndf', 
   size = 2Mb, maxsize=5Mb, filegrowth=1Mb),
filegroup G2
( name = AUDITORIUM, filename = N'C:\UNIVER\ RAM_UNIVER21.ndf', 
   size = 5Mb, maxsize=10Mb, filegrowth=1Mb)
log on
( name = N'RAM_UNIVER_log', filename=N'C:\UNIVER\ RAM_UNIVER122.ldf',       
